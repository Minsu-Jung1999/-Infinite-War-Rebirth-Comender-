...
public class SpawnedUnitsIndicator : MonoBehaviour
{
    ...
    [SerializeField] TMP_Text Skeleton_Archer;
    [SerializeField] TMP_Text Skeleton_Dagger;
        ...
        foreach (Transform unit in unitsParent)
        {
            ...
            switch (species)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Skeleton_Archer.text = activeChildCount.ToString();
                    break;
                case 6:
                    Skeleton_Dagger.text = activeChildCount.ToString();
                    break;
                default:
                    break;
            }
